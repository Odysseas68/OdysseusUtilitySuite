...
| Delves | Legacy shift-drag movement has no explicit lock checkbox. | OUS2 documents Shift-drag and has reset position. | PASS | Do not add lock/unlock unless a future behavior review creates a real DB/runtime contract. |
