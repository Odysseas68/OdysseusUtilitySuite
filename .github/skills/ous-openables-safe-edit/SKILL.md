...
12. Preserve the completed reusable OUS2 custom scale-control integration through `C.CreateScaleControl`, `T.Tex` scale assets, and `T.Scale.*`. Do not replace it with Blizzard `OptionsSliderTemplate` unless explicitly requested.
