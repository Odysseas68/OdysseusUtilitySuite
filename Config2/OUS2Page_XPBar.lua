...
local sectionRows = {
    ...
    { key = "repairs", label = "Show Repairs", help = "Show or hide the total known cost of repairs initiated by OUS, including personal, guild-funded, and mixed guild/personal repairs.", y = -204, left = false },
